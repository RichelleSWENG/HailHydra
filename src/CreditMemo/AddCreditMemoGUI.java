...
public class AddCreditMemoGUI extends CreditMemoGUI implements TableModelListener
{
               ...
               cmbSupplier.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
               ...
               TableColumn col = tbCreditMemo.getColumnModel().getColumn(1);
                    col.setCellEditor(new AddCreditMemoGUI.MyComboBoxEditor(partNums));
                    col.setCellRenderer(new AddCreditMemoGUI.MyComboBoxRenderer(partNums));
