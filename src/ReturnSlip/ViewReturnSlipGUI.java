...
public class ViewReturnSlipGUI extends ReturnSlipGUI implements
		TableModelListener
{
	...
	public void setViewComponents()
	{
		...
		{
			PO = mainController.getPurchaseOrderNumber(cmbPTNum
		...
		cmbSupplier.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				if (cmbSupplier.getSelectedIndex() != 0)
				{
					...
					TableColumn col = tbReturnSlip.getColumnModel()
							.getColumn(1);
					col.setCellEditor(new ViewReturnSlipGUI.MyComboBoxEditor(
							partNums));
					col.setCellRenderer(new ViewReturnSlipGUI.MyComboBoxRenderer(
							partNums));
