...
public class ReturnSlip
{
	...
	public ReturnSlip(String return_slip_id, int company_id, String date,
			float total_amount, int purchase_transaction_num,
			String purchase_order_num, String returned_by,
			String returned_date, String approved_by, String approved_date,
			String received_by, String received_date, String notes,
			String type, ArrayList<RSLineItem> list)
	{
