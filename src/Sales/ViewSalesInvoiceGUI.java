...
public class ViewSalesInvoiceGUI extends SalesInvoiceGUI implements
		TableModelListener
{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				if (cmbCustomer.getSelectedIndex() != 0)
				{
					...
					TableColumn col = tbSalesInvoice.getColumnModel()
							.getColumn(1);
					col.setCellEditor(new ViewSalesInvoiceGUI.MyComboBoxEditor(
							partNums));
					col.setCellRenderer(new ViewSalesInvoiceGUI.MyComboBoxRenderer(
							partNums));
				}
				numItems = 0;
