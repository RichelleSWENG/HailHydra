...
public class SILineItemModel
{
	...
	public ResultSet getDetail(String ID, String partnum)
	{
		...
		try
		{
			...
			String sql = "SELECT quantity,part_num,unit_price,line_total FROM silineitem WHERE sales_invoice_id='"
	...
	public void addDetail(SILineItem lineitem)
	{
		...
		{
			statement = db.createStatement();
			String sql = "INSERT INTO silineitem(sales_invoice_id,quantity,part_num,unit_price,line_total) VALUES('"
					+ lineitem.getSales_invoice_id()
					+ "','"
