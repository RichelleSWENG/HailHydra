...
public class SalesInvoiceListGUI extends JPanel
{
	...
	private JRadioButton rdbtnCustomerName, rdbtnSalesInvoiceNo,
			rdbtnPartNumber;
	...
	public SalesInvoiceListGUI(GUIController temp)
	{
		...
		cmbToYear.addActionListener(new ActionListener()
		{
			...
			{
				tfSearch.setText("");
				mainController.ViewSalesInvoicebyDate(
		...
		btnViewSalesInvoice.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					mainController.setTarget(mainController
							.getSI(tbSalesInvoice.getValueAt(row, 2).toString()));
