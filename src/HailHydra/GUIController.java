...
public class GUIController
{
	...
	public void AccessRestricted()
	{
		JOptionPane
				.showMessageDialog(
						null,
						"<html><center>You do not have access to this feature.<br>Please contact the administrator.</center></html>");
	}

	public void changePanelToPayablesList()
	{
		PayablesListGUI tempGUI = new PayablesListGUI(this);
		tempGUI.setMainController(new PayablesController(
				new PayablesModel(dbc), tempGUI));
		tempGUI.ViewAll();
		getContentPanel().add(tempGUI);
		frameRevalidate();
	}
	...
	public void changePanelToAddPaymentPayables()
	{
		if (administrator)
		{
			...
			tempGUI.setMainController(new PaymentController(new PaymentModel(
					dbc), tempGUI));
			tempGUI.ViewAll();
			getContentPanel().add(tempGUI);
			frameRevalidate();
	...
	{
		PurchaseTransactionListGUI tempGUI = new PurchaseTransactionListGUI(
				this);
		PTController = new PurchaseTransactionController(
				new PurchasesModel(dbc), tempGUI);
	...
	public void changePanelToAddPurchaseTransaction()
	{
		...
		{
			PTController = new PurchaseTransactionController(
					new PurchasesModel(dbc));
			AddPurchaseTransactionGUI tempGUI = new AddPurchaseTransactionGUI(
					this);
	...
	public void changePanelToModifyPurchaseTransaction()
	{
		if (administrator)
		{
			ModifyPurchaseTransactionGUI tempGUI = new ModifyPurchaseTransactionGUI(
					this);
			tempGUI.setController(PTController);
			tempGUI.setViewComponents();
			getContentPanel().add(tempGUI);
	...
	{
		ViewPurchaseTransactionGUI tempGUI = new ViewPurchaseTransactionGUI(
				this);
		tempGUI.setController(PTController);
		tempGUI.setViewComponents();
		// tempGUI.setDataComponents();
	...
	{
		ViewItemProfileGUI tempGUI = new ViewItemProfileGUI(this,
				inventoryController);
		tempGUI.setMainController(inventoryController);
		getContentPanel().add(tempGUI);
		frameRevalidate();
	...
	public void changePanelToModifyItemProfile() throws IOException
	{
		if (administrator)
		{
			ModifyItemProfileGUI tempGUI = new ModifyItemProfileGUI(this,
					inventoryController);
			getContentPanel().add(tempGUI);
			frameRevalidate();
		} else
	...
	public void changePanelToSetInventoryLastCost()
	{
		if (administrator)
		{
			...
			tempGUI.setMainController(new LastCostController(
					new ItemModel(dbc), tempGUI));
			tempGUI.ViewAll();
			getContentPanel().add(tempGUI);
			frameRevalidate();
		} else
	...
	public void changePanelToSetInventorySellingPrice()
	{
		if (administrator)
		{
			SetInventorySellingPriceGUI tempGUI = new SetInventorySellingPriceGUI(
					this);
			tempGUI.setMainController(new SellingPriceController(new ItemModel(
					dbc), tempGUI));
			tempGUI.ViewAll();
			getContentPanel().add(tempGUI);
			frameRevalidate();
	...
	public void changePanelToSetInventoryQuantity()
	{
		if (administrator)
		{
			...
			tempGUI.setMainController(new QuantityController(
					new ItemModel(dbc), tempGUI));
			tempGUI.ViewAll();
			getContentPanel().add(tempGUI);
			frameRevalidate();
	...
	{
		AcknowledgementReceiptListGUI tempGUI = new AcknowledgementReceiptListGUI(
				this);
		ARController = new AcknowledgementReceiptController(
				new AckReceiptModel(dbc), tempGUI);
	...
	public void changePanelToAddAcknowledgementReceipt()
	{
		if (administrator)
		{
			...
			AddAcknowledgementReceiptGUI tempGUI = new AddAcknowledgementReceiptGUI(
					this);
			tempGUI.setMainController(ARController);
			tempGUI.setDataComponents();
			getContentPanel().add(tempGUI);
	...
	{
		ViewAcknowledgementReceiptGUI tempGUI = new ViewAcknowledgementReceiptGUI(
				this);
		tempGUI.setMainController(ARController);
		tempGUI.setViewComponents();
		getContentPanel().add(tempGUI);
	...
	public void changePanelToModifyAcknowledgementReceipt()
	{
		if (administrator)
		{
			ModifyAcknowledgementReceiptGUI tempGUI = new ModifyAcknowledgementReceiptGUI(
					this);
			tempGUI.setMainController(ARController);
			tempGUI.setViewComponents();
			getContentPanel().add(tempGUI);
	...
	public void changePanelToCollectibles()
	{
		...
		tempGUI.setMainController(new CollectiblesController(
				new CollectiblesModel(dbc), tempGUI));
		tempGUI.ViewAll();
		getContentPanel().add(tempGUI);
		frameRevalidate();
	...
	public void changePanelToAddPaymentCollectibles()
	{
		if (administrator)
		{
			AddPaymentCollectiblesGUI tempGUI = new AddPaymentCollectiblesGUI(
					this);
			tempGUI.setMainController(new PaymentCollectiblesController(
					new PaymentCollectiblesModel(dbc), tempGUI));
			tempGUI.ViewAll();
			getContentPanel().add(tempGUI);
			frameRevalidate();
		} else
	...
	{
		ViewPaymentCollectiblesGUI tempGUI = new ViewPaymentCollectiblesGUI(
				this);
		tempGUI.setMainController(new PaymentCollectiblesController(
				new PaymentCollectiblesModel(dbc)));
	...
	public void changePanelToAccountProfile()
	{
		...
		accountProfileController = new AccountProfileController(
				new AccountModel(dbc), tempGUI);
	...
	{
		ViewAccountProfileGUI tempGUI = new ViewAccountProfileGUI(this,
				accountProfileController); // needed access to Account
											// controller beacuse it contains
											// what to display
		tempGUI.setMainController(accountProfileController);
		getContentPanel().add(tempGUI);
		frameRevalidate();
	...
	public void changePanelToModifyAccountProfile()
	{
		if (administrator)
		{
			ModifyAccountProfileGUI tempGUI = new ModifyAccountProfileGUI(this,
	...
	public void changePanelToCreditLimitReport()
	{
		...
		tempGUI.setMainController(new ReportController(new ReportModel(dbc),
				tempGUI));
		tempGUI.ViewAll();
		getContentPanel().add(tempGUI);
		frameRevalidate();
	...
	public void changePanelToCreditMemo()
	{
		...
		tempGUI.setRSController(RSController);
		CMController = new CreditMemoController(new CreditMemoModel(dbc),
				tempGUI);
	...
	public void changePanelToAddBankAccount()
	{
		if (administrator)
		{
			...
			{
				systemAccountController = new SystemAccountController(
						new SystemAccountModel(dbc));
			}
	...
	public void changePanelToModifyPassword()
	{
		if (administrator)
		{
			...
			tempGUI.setMainController(new SystemAccountController(
					new SystemAccountModel(dbc), tempGUI));
