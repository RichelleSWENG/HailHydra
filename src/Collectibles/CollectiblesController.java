...
public class CollectiblesController
{
	...
	{
		TableModel tbm = collectiblesModel.myModel(collectiblesModel
				.getCollectibles());
	...
	{
		TableModel tbm = collectiblesModel.myModel(collectiblesModel
				.getAllActiveCollectibles(startDate, endDate));
		this.itemcount = collectiblesModel.getItemcount();
		gui.setItemCount(itemcount);
	...
	{
		TableModel tbm = collectiblesModel.myModel(collectiblesModel
				.getAllClosedCollectibles(startDate, endDate));
		this.itemcount = collectiblesModel.getItemcount();
		gui.setItemCount(itemcount);
		gui.setTableModel(tbm);
	}
			...
			String endDate)
	{
		...
		if (type == 0)
			...
			searchBy = "closed";
		TableModel tbm;
		tbm = collectiblesModel.myModel(collectiblesModel.searchCollectibles(
				text, searchBy, startDate, endDate));
		this.itemcount = collectiblesModel.getItemcount();
		gui.setItemCount(itemcount);
		gui.setTableModel(tbm);
	}
	...
	public String getMaxYear()
	{
		...
		{
			Logger.getLogger(CollectiblesController.class.getName()).log(
	...
	{
		TableModel tbm = collectiblesModel.myModel(collectiblesModel
				.getCollectiblesbyDate(startDate, endDate));
		this.itemcount = collectiblesModel.getItemcount();
		gui.setItemCount(itemcount);
		gui.setTableModel(tbm);
	}
