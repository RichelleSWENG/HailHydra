...
public class PayablesController
{
	...
	{
		TableModel tbm = payablesModel.myModel(payablesModel
				.getAllActivePayables(startDate, endDate));
		this.itemcount = payablesModel.getItemcount();
		gui.setItemCount(itemcount);
	...
	{
		TableModel tbm = payablesModel.myModel(payablesModel
				.getAllClosedPayables(startDate, endDate));
		this.itemcount = payablesModel.getItemcount();
		gui.setItemCount(itemcount);
		gui.setTableModel(tbm);
	}
			...
			String endDate)
	{
		...
		if (type == 0)
			...
			searchBy = "closed";
		TableModel tbm;
		tbm = payablesModel.myModel(payablesModel.searchPayables(text,
	...
	public String getMaxYear()
	{
		...
		{
			Logger.getLogger(PayablesController.class.getName()).log(
	...
	{
		TableModel tbm = payablesModel.myModel(payablesModel.getPayablesbyDate(
				startDate, endDate));
		this.itemcount = payablesModel.getItemcount();
		gui.setItemCount(itemcount);
		gui.setTableModel(tbm);
