        ...
        cmbSupplier.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                ...
                if (cmbSupplier.getSelectedIndex() != 0)
                {
                    ...
                    col.setCellEditor(new ModifyPurchaseTransactionGUI.MyComboBoxEditor(partNums));
                    col.setCellRenderer(new ModifyPurchaseTransactionGUI.MyComboBoxRenderer(partNums));
                }
                numItems = 0;
                tbModel.setValueAt(defaultVal, numItems, 4);
            }
