...
public class ViewAccountProfileGUI extends AccountProfileGUI
{
        ...
        {            
                ...
                ftfCreditLimit.setValue(Double.parseDouble(accountProfile.get(5).toString().replaceAll(",", "")));
                ftfTerms.setValue(Integer.parseInt(accountProfile.get(6).toString().replaceAll(",", "")));
