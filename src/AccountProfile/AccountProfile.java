...
{
	private String type, name, address, city, postCode, country, phone1,
			phone2, phone3, faxNumber, emailAddress, website, contactPerson;
	...
	public static class AccountProfileBuilder
	{
		...
		private String address, city, postCode, country, phone1, phone2,
				phone3, faxNumber, emailAddress, website, contactPerson;
		private final Float creditLimit;
		public final int terms;
		public final boolean status;

		public AccountProfileBuilder(String type, String name,
				Float creditLimit, int terms, boolean status)
		{
			this.type = "customer";
			this.name = name;
