...
public class AccountProfileGUI extends JPanel
{
	protected JLabel lblHeader, lblType, lblName, lblAddress, lblCity,
			...
			lblEmailAddress, lblWebsite, lblContactPerson, lblAsterisk1,
			lblAsterisk2, lblAsterisk3, lblAsterisk4;
	protected JTextField tfName, tfCity, tfPostCode, tfCountry, tfPhone1,
			tfPhone2, tfPhone3, tfFaxNumber, tfEmailAddress, tfWebsite,
			tfContactPerson;
	...
	public AccountProfileGUI()
	{
		...
		tbCompanyDetails = BorderFactory.createTitledBorder(
				BorderFactory.createLineBorder(Color.black), "Company Details");
		...
		add(pnlAlertDetails);
		tbAlertDetail = BorderFactory.createTitledBorder(
				BorderFactory.createLineBorder(Color.black), "Alert Details");
		...
		tbContactDetails = BorderFactory.createTitledBorder(
				BorderFactory.createLineBorder(Color.black), "Contact Details");
		...
		lblTermsDays
				.setToolTipText("Terms can not exceed 2,000 and can not be negative.");
		...
		rdbtnSisterCompanyCustomer = new JRadioButton(
