...
class DMLineItemModel
{
	...
	public ResultSet getDetail(String ID, String partnum)
	{
		...
		try
		{
			...
			String sql = "SELECT quantity,part_num,unit_price,line_total FROM dmlineitem WHERE debit_memo_id='"
	...
	public void addDetail(Object obj)
	{
		...
		{
			statement = db.createStatement();
			String sql = "INSERT INTO dmlineitem(debit_memo_id,quantity,part_num,unit_price,line_total) VALUES('"
					+ lineitem.getDebit_memo_id()
					+ "','"
