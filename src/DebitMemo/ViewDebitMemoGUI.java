...
public class ViewDebitMemoGUI extends DebitMemoGUI implements
		TableModelListener
{
		...
		cmbCustomer.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				if (cmbCustomer.getSelectedIndex() != 0)
				{
					...
					col.setCellEditor(new ViewDebitMemoGUI.MyComboBoxEditor(
							partNums));
					col.setCellRenderer(new ViewDebitMemoGUI.MyComboBoxRenderer(
							partNums));
				}
	...
	public void setViewComponents()
	{
		...
		{
			Logger.getLogger(ViewDebitMemoGUI.class.getName()).log(
		...
		for (int i = 0; i < numItems; i++)
		{
			...
			{
				tbModel.setRowCount(1);
				tbModel.setValueAt(DebitMemo.getList().get(i).getQuantity(), 0,
						0);
				tbModel.setValueAt(DebitMemo.getList().get(i).getPartNum(), 0,
						1);
