...
public class DebitMemoGUI extends JPanel
{
	...
	protected JLabel lblHeader, lblCustomer, lblAddress, lblDMNum, lblDate,
			lblApprovedBy, lblReceivedBy, lblApprovedDate, lblReceivedDate,
			lblTotal, lblNotes;
	protected JTextField tfDBNum, tfSINum, tfApprovedBy, tfReceivedBy;
	protected JFormattedTextField ftfDate, ftfApprovedDate, ftfReceivedDate,
			ftfTotal;
