...
public class AcknowledgementReceiptController
{
	...
	public AcknowledgementReceiptController(AckReceiptModel ackReceiptModel,
			AcknowledgementReceiptListGUI tempGUI)
	{
	...
	public void addAR(String acknowledgement_receipt_id, String date,
			...
			String status, Company company)
	{
		AcknowledgementReceipt rcpt = new AcknowledgementReceipt(
				acknowledgement_receipt_id, date, original_amount, po_num,
				ordered_by, sales_person, delivered_by, delivery_notes,
				delivery_receipt_num, discount, current_balance, status,
				pendingItems, company);
		ackReceiptModel.addDetail(rcpt);
		// ackReceiptModel.addDetail(rcpt);
	}

	public void editAR(String acknowledgement_receipt_id, String date,
			float original_amount, String po_num, String ordered_by,
			String sales_person, String delivered_by, String delivery_notes,
			String delivery_receipt_num, float discount, float current_balance,
			String status, Company company)
	...
	{
		TableModel tbm = ackReceiptModel
				.myModel(ackReceiptModel.getAllDetail());
			...
			String endDate)
	{
		...
		TableModel tbm;
		tbm = ackReceiptModel.myModel(ackReceiptModel.searchDetail(text,
	...
	{
		TableModel tbm;
		tbm = ackReceiptModel.myModel(ackReceiptModel.getAllDetailbyDate(
				startDate, endDate));
		this.itemcount = ackReceiptModel.getItemcount();
		gui.setItemCount(itemcount);
		gui.setTableModel(tbm);
	...
	public String getMaxYear()
	{
		...
		{
			Logger.getLogger(AcknowledgementReceiptController.class.getName())
