...
public class AcknowledgementReceipt
{
	...
	public AcknowledgementReceipt(String acknowledgement_receipt_id,
			String date, float original_amount, String po_num,
			String ordered_by, String sales_person, String delivered_by,
			String delivery_notes, String delivery_receipt_num, float discount,
			float current_balance, String status, ArrayList<ARLineItem> list,
			Company company)
	{
