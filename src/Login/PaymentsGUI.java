...
public class PaymentsGUI extends JPanel
{
	...
	private JButton btnPayables, btnCollectibles, btnAddCheckAccount,
			btnAddBankAccount, btnCreditLimitReport, btnTermsReport;
	...
	public PaymentsGUI(GUIController temp)
	{
		...
		add(btnPayables);
		btnPayables.addActionListener(new ActionListener()
		{
		...
		add(btnCollectibles);
		btnCollectibles.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
		...
		btnAddCheckAccount.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
		...
		btnAddBankAccount.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
		...
		btnCreditLimitReport.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
		...
		add(btnTermsReport);
		btnTermsReport.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
